...
test_that("all srs function handles basic simple random sample", {
  ...
  expect_equal(summarize_all_srs(data, attribute = 'bapa', popSize = 40,
                                 infiniteReplacement = F), 
               summarize_simple_random(data, attribute = 'bapa', popSize = 40,
                                       infiniteReplacement = F), 
               tolerance = 0.1)
...
test_that("all srs function handles simple random sample for discrete attribute, Bernoulli", {
  ...
  expect_equal(summarize_all_srs(data, attribute = 'alive', popSize = 50,
                                 desiredConfidence = 0.95, infiniteReplacement = F, bernoulli = T), 
               summarize_simple_random_discrete(data, attribute = 'alive', popTot = 50, 
