...
test_that("all cluster function handles simple cluster sample", {
  ...
  expect_equal(summarize_all_cluster(redData, attribute = 'volume', element = TRUE, bernoulli = F), 
               summarize_cluster(redData, attribute = 'volume', element = TRUE), tolerance = 0.1)
