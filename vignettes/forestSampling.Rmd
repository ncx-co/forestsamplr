...
Note: A precurser to 3P sampling was also called Poisson sampling (discussed in Gregoire and Valentine). However, in this package Poisson sampling refers to count data and 3P considers field estimations.
