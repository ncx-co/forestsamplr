...
infiniteReplacement | logical true if sample was done with replacement or from an infinite population. False if sampled without replacement, from a finite population. Defaults to False.
  
`summarize_simple_random_discrete(data, attribute = 'attr', popTot = NA)`

 Parameter          | Description
--------------------|--------------------------------------------------------
data                | dataframe containing observations of variable of interest. Attribute must be coded as either TRUE and FALSE or 1 and 0.
attribute           | character name of attribute to be summarized.
popTot              | numeric population size. Equivalent to total number of individuals.
