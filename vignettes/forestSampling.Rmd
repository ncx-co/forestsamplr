...
Function Definition:  
```{r include = FALSE}
summarize_simple_random(data, attribute = 'attr', type = 'vector', popSize = NA, 
...
Function Definition:
```{r include = FALSE}
summarize_systematic(data, attribute = 'attr', type = 'vector', popSize = NA, 
                     desiredConfidence = 0.9)  
```
...
Function Definition:
```{r include = FALSE}
summarize_two_stage(data, plot = TRUE, attribute = NA, populationClusters = 0,
